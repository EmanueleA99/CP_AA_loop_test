...
CONFIG = SimpleNamespace(
    ...
    DESKTOP_DIR=Path(__file__).resolve().parent / "output" / "Test_Soft_Boot_CarPlay",
    FPS=2,
    PRECHECK_FRAMES=5,
    ...
    OUTPUT_CSV=Path(__file__).resolve().parent / "output" / "Test_Soft_Boot_CarPlay" / f"results_carplay_{RUN_TIMESTAMP}.csv",
